...
import icon1 from '../../assets/image/badge/icon1.png';
import icon2 from '../../assets/image/badge/icon2.png';
import icon3 from '../../assets/image/badge/Vector3.png';
import icon4 from '../../assets/image/badge/4.png';
